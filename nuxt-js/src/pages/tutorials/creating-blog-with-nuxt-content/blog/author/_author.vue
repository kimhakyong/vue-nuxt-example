<template>
  ...
  >
    ...
    <div class="absolute top-32 left-32 text-white">
      <NuxtLink to="/tutorials/creating-blog-with-nuxt-content"><BlogLogo /></NuxtLink>
    ...
    >
      <NuxtLink to="/tutorials/creating-blog-with-nuxt-content"
      ...
      <ul>
        ...
        >
          <NuxtLink
            :to="{ name: 'tutorials-creating-blog-with-nuxt-content-blog-slug', params: { slug: article.slug } }"
